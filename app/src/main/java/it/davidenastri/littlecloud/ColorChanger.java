...
public final class ColorChanger {
    ...
    /**
     * Create a private constructor because no one should ever create a {@link ColorChanger} object.
     * This class is only meant to hold static variables and methods, which can be accessed
     * directly from the class name ColorChanger (and an object instance of ColorChanger is not needed).
     */
    private ColorChanger() {
    }

    public static void executeQuery(String rgbString, final String colorSet, final View onClickView,
